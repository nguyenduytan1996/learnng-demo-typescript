...
(function (tempModule) {
    var String = /** @class */ (function () {
        ...
        String.prototype.ham1_String = function () {
            console.log("===> ham1_String");
        };
        String.prototype.ham2_String = function () {
            console.log("===> ham2_String");
        };
        return String;
    }());
    tempModule.String = String;
    var Number = /** @class */ (function () {
        function Number() {
        }
        Number.prototype.ham1_Number = function () {
            console.log("===> ham1_Number");
        };
        Number.prototype.ham2_Number = function () {
            console.log("===> ham2_Number");
        };
        return Number;
    }());
    tempModule.Number = Number;
})(tempModule || (tempModule = {}));
var varNameSpace1 = new tempModule.String.prototype.ham1_String(); // ??? sao nó call như JS thuần
var varNameSpace2 = new tempModule.String();
